...
CREATE TABLE hotel (
	...
	`checkin_date` BIGINT(20) NOT NULL DEFAULT '' COMMENT '入住时间',
	`checkout_date` BIGINT(20) NOT NULL DEFAULT '' COMMENT '退房时间',
	`guests` TINYINT(1) UNSIGNED NOT NULL DEFAULT '0' COMMENT '入住数',
    `create_time` BIGINT(20) NOT NULL DEFAULT '0' COMMENT '创建时间',
	`update_time` BIGINT(20) NOT NULL DEFAULT '0' COMMENT '更新时间',
	PRIMARY KEY(`id`),
	KEY `hotels_name` (`hotels_name`)
    KEY `idx_create_time` (`create_time`),
	KEY `idx_update_time` (`update_time`),) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT 'hotel';
